# This class is used for model construction, including all traditional machine learning algorithms.
...
class SIFSMachineLearning(object):
...
if __name__ == '__main__':
    ...
    Data = SIFSMachineLearning(ml_defatult_para)
