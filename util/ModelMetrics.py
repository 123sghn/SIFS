# This class is used to store evaluation metric data, as well as data for plotting ROC and PRC curves.
...
class ModelMetrics(object):
    ...
    def insert_data(
        self, metric_ndarray, id, auc_df, prc_df, prediction_score, model=None
    ):
...
if __name__ == "__main__":
    model = ModelMetrics()
    df = pd.DataFrame(
        [["id", "000", "111", 98, 99, 98, 99, 0.9, 0.8, 0.90, 0.91]],
        columns=[
            "Id",
            "StartTime",
            "EndTime",
    ...
    df1 = pd.DataFrame(
        [["id", "111", "111", 98, 99, 98, 99, 0.9, 0.8, 0.90, 0.91]],
        columns=[
            "Id",
            "StartTime",
            "EndTime",
